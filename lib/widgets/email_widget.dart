...
class _EmailContentState extends State<EmailContent> {
  ...
  String get lastActiveLabel {
    ...
    if (elapsedTime.inHours < 60) return '${elapsedTime.inHours}';
    if (elapsedTime.inDays < 60) return '${elapsedTime.inDays} days';
    return '${elapsedTime.inDays} days';
  }
                ...
                ? Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            fit: BoxFit.cover,
                            image: AssetImage(
                                widget.email.attachments.first.url))),
                  )
