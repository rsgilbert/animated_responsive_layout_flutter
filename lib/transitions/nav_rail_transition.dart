...
class NavRailTransition extends StatefulWidget {
  ...
  @override 
  State<NavRailTransition> createState() => _NavRailTransition();
}


class _NavRailTransition extends State<NavRailTransition> {
  // The animations are only rebuilt by this method when the text 
  // direction changes because this widget only depends on Directionality 
  late final ltr = Directionality.of(context) == TextDirection.ltr;
